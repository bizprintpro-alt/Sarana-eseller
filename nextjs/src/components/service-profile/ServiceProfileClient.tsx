      ...
      <nav className="sticky top-0 z-40 bg-white/95 backdrop-blur-xl border-b border-gray-100 shadow-sm">
        <div className="max-w-3xl mx-auto h-14 flex items-center justify-between px-4">
          ...
          <button
            ...
            className="bg-indigo-600 text-white text-sm font-semibold px-4 py-2 rounded-lg hover:bg-indigo-700 transition border-none cursor-pointer flex items-center gap-1.5"
          >
      ...
      <section className="bg-gradient-to-b from-indigo-50 to-white">
        <div className="max-w-3xl mx-auto px-4 py-10 sm:py-14">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
            {/* Avatar */}
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-indigo-600 flex items-center justify-center text-white text-3xl font-bold shadow-lg shrink-0">
              {shop.logo ? (
                    ...
                    <div key={s._id} className="bg-white border border-gray-200 rounded-xl p-4 flex items-center gap-4 hover:shadow-md hover:border-gray-300 transition-all group">
                      ...
                      <div className="text-right shrink-0">
                        ...
                        <button
                          ...
                          className="mt-2 bg-indigo-600 text-white text-xs font-semibold px-3 py-1.5 rounded-lg hover:bg-indigo-700 transition border-none cursor-pointer"
                        >
                          Цаг захиалах
                        </button>
                      </div>
