    ...
    return (
      <div className="min-h-screen bg-gray-50 p-4 md:p-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center max-w-lg mx-auto">
          ...
          <a href="/dashboard/seller/package" className="inline-block bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-6 py-3 rounded-xl font-semibold hover:opacity-90 transition">
            Багц шинэчлэх
          </a>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-bold text-gray-900 text-sm">Борлуулалт 15% буурсан</h3>
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <span className="text-xs text-gray-400">2 цагийн өмнө</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-bold text-gray-900 text-sm">Шилдэг 3 бараагаа 10% хямдруулвал 25% өсөлт гарна</h3>
              <p className="text-sm text-gray-500 mt-1">
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <span className="text-xs text-gray-400">5 цагийн өмнө</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-bold text-gray-900 text-sm">Ирэх 7 хоногт 45 захиалга хүлээгдэж байна</h3>
              <p className="text-sm text-gray-500 mt-1">
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <span className="text-xs text-gray-400">1 өдрийн өмнө</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-bold text-gray-900 text-sm">Хямдралтай бараа нэмэх нь +30% борлуулалтыг нэмэгдүүлнэ</h3>
              <p className="text-sm text-gray-500 mt-1">
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <span className="text-xs text-gray-400">3 өдрийн өмнө</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
        <h2 className="font-bold text-gray-900 mb-4">7 хоногийн борлуулалтын хандлага</h2>
        <div className="flex items-end gap-3 h-48">
          {WEEKLY_DATA.map((d) => {
            const height = (d.sales / maxSales) * 100;
            return (
              <div key={d.day} className="flex-1 flex flex-col items-center gap-2">
                <span className="text-xs font-semibold text-gray-700">{d.sales}</span>
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
          <div>
            <span className="text-sm text-gray-500">Нийт захиалга</span>
            <p className="text-xl font-bold text-gray-900">{WEEKLY_DATA.reduce((a, d) => a + d.sales, 0)}</p>
          </div>
          <div>
            <span className="text-sm text-gray-500">Нийт орлого</span>
            <p className="text-xl font-bold text-gray-900">
              {(WEEKLY_DATA.reduce((a, d) => a + d.revenue, 0) / 1000000).toFixed(1)}M₮
            </p>
          </div>
          <div>
            <span className="text-sm text-gray-500">Дундаж/өдөр</span>
            <p className="text-xl font-bold text-gray-900">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-lg">📊</span>
            <h3 className="font-bold text-gray-900 text-sm">Хамгийн эрэлттэй цаг</h3>
          </div>
          <p className="text-3xl font-black text-gray-900">14:00-18:00</p>
          <p className="text-sm text-gray-500 mt-1">Захиалгын 65% энэ цагт ирдэг</p>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-lg">🏆</span>
            <h3 className="font-bold text-gray-900 text-sm">Шилдэг ангилал</h3>
          </div>
          <p className="text-3xl font-black text-gray-900">Хувцас</p>
          <p className="text-sm text-gray-500 mt-1">Нийт борлуулалтын 42%</p>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-lg">👥</span>
            <h3 className="font-bold text-gray-900 text-sm">Давтан худалдан авалт</h3>
          </div>
          <p className="text-3xl font-black text-gray-900">23%</p>
          <p className="text-sm text-gray-500 mt-1">Хэрэглэгчдийн 23% дахин захиалдаг</p>
